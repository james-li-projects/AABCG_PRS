#!/bin/bash
#SBATCH --job-name=FINAL_PRS_MODELS_SCORE_PRS
#SBATCH --output=/gpfs/data/huo-lab/BCAC/james.li/PRS_AABCG/logs/FINAL_PRS_MODELS_SCORE_PRS_%A.out
#SBATCH --error=/gpfs/data/huo-lab/BCAC/james.li/PRS_AABCG/logs/FINAL_PRS_MODELS_SCORE_PRS_%A.err
#SBATCH --time=2:00:00
#SBATCH --nodes=1
...
output_score_path=/gpfs/data/huo-lab/BCAC/james.li/PRS_AABCG/output/FINAL_SCORE_OUTPUT/${subtype}
