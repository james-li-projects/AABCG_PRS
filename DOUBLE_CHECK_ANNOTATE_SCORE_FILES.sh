#!/bin/bash
#SBATCH --job-name=DOUBLE_CHECK_ANNOTATE_SCORE_FILES
#SBATCH --output=/gpfs/data/huo-lab/BCAC/james.li/PRS_AABCG/logs/DOUBLE_CHECK_ANNOTATE_SCORE_FILES_%A.out
#SBATCH --error=/gpfs/data/huo-lab/BCAC/james.li/PRS_AABCG/logs/DOUBLE_CHECK_ANNOTATE_SCORE_FILES_%A.err
#SBATCH --time=2:00:00
#SBATCH --nodes=1
...
subtype=${ARGS1}
score_prefix=${ARGS2}
input_score_path=/gpfs/data/huo-lab/BCAC/james.li/PRS_AABCG/output/CALIBRATION_FINAL_PRS_MODELS_LIFTOVER/DOUBLE_CHECK/SCORE_FILES
